...
# Data loading params
tf.flags.DEFINE_string("pos_dir", "data/positive.txt", "Path of positive data")
tf.flags.DEFINE_string("neg_dir", "data/negative.txt", "Path of negative data")
...
tf.flags.DEFINE_float("learning_rate", 0.1, "Which learning rate to start with. (Default: 1e-3)")
